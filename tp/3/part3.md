...
```bash
# liste des controllers CGroups dispos
ls /sys/fs/cgroup/

# quantité de mémoire max autorisée
cat /sys/fs/cgroup/memory/memory.limit_in_bytes

# noms de tous les CGroups créés
ls /sys/fs/cgroup/
```
...
# activer les controllers cpu, cpuset et memory
echo "+cpu +cpuset +memory" | sudo tee /sys/fs/cgroup/meow/cgroup.subtree_control
```
